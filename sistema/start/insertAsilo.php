...
if ($row[0] > 0) {
  echo "<script language='javascript' type='text/javascript'>alert('Esse CNPJ já está cadastrado.');window.location.href='gerenciamentoAsilos.php';</script>";
  die();
} else {
  ...
  if ($estadoSQL4) {
    echo "<script language='javascript' type='text/javascript'>alert('Asilo cadastrado com sucesso!');window.location.href='gerenciamentoAsilos.php'</script>";
  } else {
    echo "<script language='javascript' type='text/javascript'>alert('Não foi possível cadastrar esse asilo');window.location.href='gerenciamentoAsilos.php'</script>";
  }
}