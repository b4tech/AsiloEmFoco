<?php
    ...
    try {
        try {
            ...
            $query = mysqli_query($connect, "UPDATE formacaofuncionario SET tipoFormacao = '$tipoFormacao' WHERE idFormacaoFuncionario = '$idFormacaoFuncionario'");
            // if () {
            //     echo "Record updated successfully";
            // } else {
            //     echo "Error updating record: " . mysqli_error($connect);
            // }
            echo "<script language='javascript' type='text/javascript'>alert('Funcionário atualizado com sucesso!');</script>";
            // javascript:window.location='gerenciamentoFuncionarios.php';
        } catch (\Throwable $th) {
            echo $th;
        }
    } catch (\Throwable $th) {
