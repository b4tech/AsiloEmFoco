...
$query = mysqli_query($connect, "SELECT * FROM funcionario WHERE idFuncionario = $id");
$arrayFuncionario = mysqli_fetch_assoc($query);
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
    ...
    <?php $_SESSION['idFuncionario'] = $id ?>
    <?php $_SESSION['nomeFuncionario'] = $arrayFuncionario['nome']; ?>
    <?php $_SESSION['cpfFuncionario'] = $arrayFuncionario['cpf']; ?>
    <?php $_SESSION['emailFuncionario'] = $arrayFuncionario['email']; ?>
    <?php $_SESSION['dataNascFuncionario'] = $arrayFuncionario['dataNasc']; ?>
    <?php $_SESSION['contatoFuncionario'] = $arrayFuncionario['contatoId']; ?>
    <?php $_SESSION['enderecoFuncionario'] = $arrayFuncionario['enderecoId']; ?>
    <?php $_SESSION['formacaoFuncionario'] = $arrayFuncionario['formacaoId']; ?>
    <!-- Page Content -->
    <center>
        <div class="main">
                ...
                <section>
                    <form action="updateFuncionario.php" method="POST">
                        <div class="form-group margin" id="funcionario">
                            ...
                            <label for="nomeFuncionario">Nome completo:</label> <input class="form-control" type="text" id="nomeFuncionario" name="nomeFuncionario" required value="<?php echo $arrayFuncionario['nome']; ?>"><br />
