...
if ($row[0] > 0) {
  ...
  if ($estadoSQL4) {
    echo "<script language='javascript' type='text/javascript'>alert('Responsável cadastrado com sucesso!');window.location.href='gerenciamentoResponsaveis.php'</script>";
  } else {
    echo "<script language='javascript' type='text/javascript'>alert('Não foi possível cadastrar esse responsável');window.location.href='gerenciamentoResponsaveis.php'</script>";
  }
}
